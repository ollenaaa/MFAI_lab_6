...
class GameLoop:
    def __init__(self):
        ...
        self.x_color = (97, 189, 92)
        self.o_color = (242, 238, 105)
    ...
    def DrawBoard(self):
        for xy in range(200, 401, 200):
            pygame.draw.line(self.screen, self.foreground_color, (0, xy), (600, xy), 3)
            pygame.draw.line(self.screen, self.foreground_color, (xy, 0), (xy, 600), 3)

    def DrawX(self, x, y):
        x += 1
        y += 1
        pygame.draw.line(self.screen, self.x_color, (200 * x - 200 + 10, 200 * y - 200 + 10), ((x * 200) - 10, (y * 200) - 10), 10)
        pygame.draw.line(self.screen, self.x_color, (200 * x - 200 + 10, (y * 200) - 10), ((x * 200) - 10, 200 * y - 200 + 10), 10)

    def DrawO(self, x, y):
        x += 1
        y += 1
        pygame.draw.circle(self.screen, self.o_color,(x * 200 - 100, y * 200 - 100), 90, 10)
    ...
    def GameOver(self):
        ...
        if self.GameState == 1:
            ...
            pygame.display.set_caption('x won this game')
        elif self.GameState == 0:
            print('None Won')
            pygame.display.set_caption('none won')
        elif self.GameState == -1:
            print('o won this Game')
            pygame.display.set_caption('o won this game')
